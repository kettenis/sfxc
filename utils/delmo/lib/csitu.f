...
!       and ocean loading. The J2000.0 geocentric baseline position and velocity
!       vectors are similiarly corrected.
!
...
!   corrections to the J2000.0 geocentric site vectors.
      DO 100 L = 1,2
!       Add tide and ocean, then add pole tide. Positions then velocities.
