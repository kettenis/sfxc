...
public:
    ...
    // icount-1 delta psi value in asec
    double DeltaPsi( const int& icount) const;

    // icount-1 delta epsilon value in asec
    double DeltaEps( const int& icount) const;
   ...
   std::string Link_freq_bbc( const std::string& stat, const std::string& mode,
    ...
    double LO( const std::string& stat, const std::string& mode, const int& icount ) const;
