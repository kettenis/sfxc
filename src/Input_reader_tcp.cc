...
Input_reader_tcp::Input_reader_tcp(int port) 
  : buffer(), msglev(-1)
{
...
Input_reader_tcp::~Input_reader_tcp() {
}

INT64 Input_reader_tcp::move_forward(INT64 nBytes) {
  assert(nBytes >= 0);
...
INT64 Input_reader_tcp::get_bytes(INT64 nBytes, char*out) {
